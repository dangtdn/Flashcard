...
import { katakana } from "../../assets/list-katakna";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
const KatakanaPage = () => {
  const [cards, setCards] = useState(katakana);
  ...
  const handleClickRandom = () => {
    const shuffledArray = shuffleArray(katakana);
  ...
  return (
    <main className="md:pl-56 h-full md:pt-0 pt-[80px]">
      ...
      <div className="p-6">
        <p className="text-3xl font-bold uppercase">Flashcard Katakana</p>
